...
Board.prototype.markSquareAt = function(key, marker) { // key is location choice, marker is HUMAN_MARKER
...
Board.prototype.countMarkersFor = function(player, keys) { // key is array of keys from which to count player's markers
...
TTTGame.prototype.someoneWon = function() { // detect if someone won
  return this.isWinner(this.human) || this.isWinner(this.computer);
};

TTTGame.prototype.isWinner = function(player) { // detect who won
